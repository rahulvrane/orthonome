...
int main(int argc, char** argv)
{
	if(argc!=8)
	{
		cout << "Usage: familySeparator <HM.cluster> <G1.pep> <G2.pep> <G1.nuc> <G2.nuc> <G1.infox> <G2.infox>" << endl;
		exit(1);
	}
	ifstream infile1(argv[1]), infile2(argv[2]), infile3(argv[3]), infile4(argv[4]), infile5(argv[5]), infile6(argv[6]), infile7(argv[7]);
